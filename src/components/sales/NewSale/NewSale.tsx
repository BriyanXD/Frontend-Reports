...
import { aloneNumbers } from "../../../utils/regEx";
...
const NewSale = () => {
    ...
    const valitdationsFrom = (formData: Sale) => {
        ...
        else if(aloneNumbers.test(String(formData.quantity))) errors.quantity = "EL campo 'Cantidad' solo admite valores numericos."
        return errors;
    }
    ...
    return(
        <form className="d-flex flex-column gap-2" onSubmit={e => handleSubmit(e, postNewSale)}>
            ...
            <div className="input-group flex-nowrap">
                ...
                <input type="text" className="form-control" value={formData.entri} placeholder="entri" aria-label="entri" aria-describedby="addon-wrapping" name="entri" onChange={handleChange}/>
            </div>
            <div className="input-group flex-nowrap">
            ...
            <div className="card">
                <div className="card-body d-flex justify-content-around">
                    <input type="submit" className="btn btn-primary" value="Vender" disabled={loading}/>
